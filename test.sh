...
(sleep 0.5; echo "msg 0 0 Hello world"; sleep 0.5; echo "exit") | ./project2 -r 1 -s 1 > .output.1 2> .debug_output.1
...
(sleep 0.5; for i in `seq 1 10`; do echo "msg 0 0 Packet: $i"; sleep 0.1; done; sleep 1; echo "exit") | ./project2 -r 1 -s 1 > .output.2 2> .debug_output.2

(for i in `seq 1 10`; do echo "<RECV-0>:[Packet: $i]"; done) > .expected_output.2
...
(sleep 0.5; echo "msg 0 0 12345678#1@2345678#2@2345678#3@2345678#4@2345678#5@2345678#6@2345678#7@2345678#8@2345678#9"; sleep 0.5; echo "exit") |
 ./project2 -r 1 -s 1 > .output.3 2> .debug_output.3
...
(sleep 0.5; for i in `seq 1 50`; do echo "msg 0 0 Packet: $i"; sleep 0.01; done; sleep 30; echo "exit") | ./project2 -c 0.5 -r 1 -s 1 > .output.4 2> .debug_output.4

(for i in `seq 1 50`; do echo "<RECV-0>:[Packet: $i]"; done) > .expected_output.4
...
(sleep 0.5; for i in `seq 1 30`; do echo "msg 0 0 Packet: $i"; sleep 0.1; done; sleep 5; echo "exit") | ./project2 -d 0.2 -c 0.2 -r 1 -s 1 > .output.5 2> .debug_output.5

(for i in `seq 1 30`; do echo "<RECV-0>:[Packet: $i]"; done) > .expected_output.5
...
(sleep 0.5; for i in `seq 1 30`; do echo "msg 0 0 Packet: $i"; sleep 0.1; done; sleep 5; echo "exit") | ./project2 -d 0.35 -c 0.35 -r 1 -s 1 > .output.6 2> .debug_output.6

(for i in `seq 1 30`; do echo "<RECV-0>:[Packet: $i]"; done) > .expected_output.6
